...
console.log('Step 4: Testing with simple AuthContext');
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#fef2f2', padding: '20px' }}>
      <div style={{ backgroundColor: 'white', padding: '20px', borderRadius: '8px', marginBottom: '20px' }}>
        <h1 style={{ color: '#000', marginBottom: '10px' }}>A DATING! APP - Step 4</h1>
        <p style={{ color: '#000' }}>Testing with simple AuthContext... User: {user?.name || 'None'}</p>
      </div>
      <Navbar />
